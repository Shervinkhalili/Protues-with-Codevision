...
_0x0:
	.DB  0x54,0x68,0x61,0x74,0x73,0x20,0x63,0x6F
	.DB  0x72,0x72,0x65,0x63,0x74,0x2E,0x2E,0x2E
	.DB  0x0,0x49,0x6E,0x63,0x6F,0x72,0x72,0x65
	.DB  0x63,0x74,0x20,0x61,0x6E,0x73,0x77,0x65
	.DB  0x72,0x0,0x61,0x6E,0x73,0x77,0x65,0x72
	.DB  0x20,0x69,0x73,0x20,0x0,0x77,0x68,0x61
	.DB  0x74,0x3F,0x3F,0x0,0x47,0x75,0x65,0x73
	.DB  0x74,0x20,0x74,0x68,0x65,0x20,0x6E,0x75
	.DB  0x6D,0x62,0x65,0x72,0x3F,0x3F,0x3F,0x0
	.DB  0x47,0x75,0x65,0x73,0x74,0x20,0x74,0x68
...
; 0000 0015     if(k == key){
	...
	CPC  R31,R27
	BRNE _0x4
; 0000 0016     lcd_gotoxy(6,9);
	LDI  R30,LOW(6)
	ST   -Y,R30
	LDI  R26,LOW(9)
	CALL _lcd_gotoxy
; 0000 0017     lcd_putsf("Thats correct...") ;
	__POINTW2FN _0x0,0
	RJMP _0x27
; 0000 0018     }
; 0000 0019     else{
...
; 0000 001A      lcd_gotoxy(0,0);
	CALL SUBOPT_0x0
; 0000 001B     lcd_putsf("Incorrect answer");
	__POINTW2FN _0x0,17
	CALL _lcd_putsf
; 0000 001C     lcd_gotoxy(2,1);
	LDI  R30,LOW(2)
	ST   -Y,R30
	LDI  R26,LOW(1)
	CALL _lcd_gotoxy
; 0000 001D     lcd_putsf("answer is ") ;
	__POINTW2FN _0x0,34
_0x27:
	CALL _lcd_putsf
; 0000 001E    }
...
_0x3:
; 0000 0021   {
; 0000 0022    lcd_gotoxy(6,9);
	LDI  R30,LOW(6)
	ST   -Y,R30
	LDI  R26,LOW(9)
	CALL _lcd_gotoxy
; 0000 0023    lcd_putsf("what??");
	__POINTW2FN _0x0,45
	CALL _lcd_putsf
; 0000 0024   }
_0x6:
...
; 0000 002B   lcd_gotoxy(0,0);
	CALL SUBOPT_0x0
; 0000 002C   lcd_putsf("Guest the number???");
	__POINTW2FN _0x0,52
	CALL _lcd_putsf
; 0000 002D }
	LD   R17,Y+
...
; 0000 005B // INT0: On
; 0000 005C // INT0 Mode: Falling Edge
...
; 0000 0078 DDRC=0xf0;
	LDI  R30,LOW(240)
	OUT  0x14,R30
; 0000 0079 PORTC=0x0f;
	LDI  R30,LOW(15)
	OUT  0x15,R30
; 0000 007A lcd_gotoxy(0,0);
	CALL SUBOPT_0x0
; 0000 007B lcd_putsf("Guest the number");
	__POINTW2FN _0x0,72
	CALL _lcd_putsf
; 0000 007C while (1)
_0x7:
...
; .FEND
;char getkey(){
; 0000 0082 char getkey(){
_getkey:
; .FSTART _getkey
; 0000 0083   unsigned char key_code = 0xFF;       //az in motaqir dr interupt estfade konim
; 0000 0084     PORTD=0xFF;
	ST   -Y,R17
;	key_code -> R17
	LDI  R17,255
	LDI  R30,LOW(255)
...
; 0000 0086     PORTC.4=0;
	CBI  0x15,4
; 0000 0087     if(PINC.0==0){key_code=1;}
	SBIS 0x13,0
	LDI  R17,LOW(1)
; 0000 0088     if(PINC.1==0){key_code=2;}
	SBIS 0x13,1
	LDI  R17,LOW(2)
; 0000 0089     if(PINC.2==0){key_code=3;}
	SBIS 0x13,2
	LDI  R17,LOW(3)
; 0000 008A     PORTC.4=1;
	SBI  0x15,4
...
; 0000 008C      PORTC.5=0;
	CBI  0x15,5
; 0000 008D     if(PINC.0==0){key_code=4;}
	SBIS 0x13,0
	LDI  R17,LOW(4)
; 0000 008E     if(PINC.1==0){key_code=5;}
	SBIS 0x13,1
	LDI  R17,LOW(5)
; 0000 008F     if(PINC.2==0){key_code=6;}
	SBIS 0x13,2
	LDI  R17,LOW(6)
; 0000 0090     PORTC.5=1;
	SBI  0x15,5
...
; 0000 0092      PORTC.6=0;
	CBI  0x15,6
; 0000 0093     if(PINC.0==0){key_code=7;}
	SBIS 0x13,0
	LDI  R17,LOW(7)
; 0000 0094     if(PINC.1==0){key_code=8;}
	SBIS 0x13,1
	LDI  R17,LOW(8)
; 0000 0095     if(PINC.2==0){key_code=9;}
	SBIS 0x13,2
	LDI  R17,LOW(9)
; 0000 0096     PORTC.6=1;
	SBI  0x15,6
...
; 0000 0098      PORTC.7=0;
	CBI  0x15,7
; 0000 0099     if(PINC.0==0){key_code=10;}
	SBIS 0x13,0
	LDI  R17,LOW(10)
; 0000 009A     if(PINC.1==0){key_code=0;}
	SBIS 0x13,1
	LDI  R17,LOW(0)
; 0000 009B     if(PINC.2==0){key_code=11;}
	SBIS 0x13,2
	LDI  R17,LOW(11)
; 0000 009C     PORTC.7=1;
	SBI  0x15,7
; 0000 009D 
; 0000 009E     PORTC=0x0f;
	LDI  R30,LOW(15)
	OUT  0x15,R30
; 0000 009F     return key_code;
	MOV  R30,R17
	LD   R17,Y+
	RET
; 0000 00A0 }
